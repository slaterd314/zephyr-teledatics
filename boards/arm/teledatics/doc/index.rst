...
The Zephyr teledatics_imx8mm board configuration supports the following hardware
features:
...
:zephyr_file:`boards/arm/teledatics_imx8mm/teledatics_imx8mm_defconfig`.
...
configuration is done in the file ``boards/arm/teledatics_imx8mm/teledatics_imx8mm.dts``
